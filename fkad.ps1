...
# WinPEAS
try {
    & { IEX (iwr 'https://raw.githubusercontent.com/peass-ng/PEASS-ng/master/winPEAS/winPEASps1/winPEAS.ps1').Content } *>&1 | Out-File "$OUT\winpeas.txt" -Encoding utf8
    Write-Host "[OK] WinPEAS -> winpeas.txt" -ForegroundColor Green
} catch { Write-Host "[--] WinPEAS failed: $_" -ForegroundColor DarkGray }

# HardeningKitty
try {
    IEX (iwr 'https://raw.githubusercontent.com/scipag/HardeningKitty/master/HardeningKitty.ps1').Content
...
# ScriptSentry
try {
    & { IEX (iwr 'https://raw.githubusercontent.com/techspence/ScriptSentry/main/ScriptSentry.ps1').Content } *>&1 | Out-File "$OUT\scriptsentry.txt" -Encoding utf8
...
# AppLocker Inspector
try {
    IEX (iwr 'https://raw.githubusercontent.com/techspence/AppLockerInspector/main/Invoke-AppLockerInspector.ps1').Content
...
# PowerUpSQL
try {
    IEX (iwr 'https://raw.githubusercontent.com/NetSPI/PowerUpSQL/master/PowerUpSQL.ps1').Content
